...
function calcRailsPosts(int $length, int $railingLength, int $postWidth): array {
...
function calcDistance(int $rails, int $posts, int $postWidth, int $railingLength): array {
    $minPosts = 2;
    $minRails = 1;
